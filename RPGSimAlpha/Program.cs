...
namespace RPGSimAlpha
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            game.ObjHandler.AddCluster(new Cluster(Cluster.Shape.Rectangle, Resources.BlockRegistry.BlockTypes.Solid, new OpenTK.Vector2(50, 50), new OpenTK.Vector2(0,0),0.01f, 1000,1000,Controller.ControlType.None));
